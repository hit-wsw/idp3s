...
class DiffusionPointcloudPolicy(BasePolicy):
    ...
    def forward(self, obs_dict: Dict[str, torch.Tensor]) -> Dict[str, torch.Tensor]:
        ...
        nobs_features, center_cond = self.obs_encoder(this_nobs)
        # reshape back to B, Do
        global_cond = nobs_features.reshape(B, -1)
        center_cond = center_cond.reshape(B, -1)
    ...
    def compute_loss(self, batch):
        ...
        if self.obs_as_global_cond:
            ...
            nobs_features, center_feature = self.obs_encoder(this_nobs)
            ...
            if "cross_attention" in self.condition_type:
                ...
                center_cond = center_feature.reshape(batch_size, -1)
        else:
            # reshape B, T, ... to B*T
